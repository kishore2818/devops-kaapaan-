...
export const API_BASE_URL = trimTrailingSlash("http://localhost:5001");
export const WS_BASE_URL = trimTrailingSlash("ws://localhost:5001");
export const CRIMINAL_API_BASE_URL = trimTrailingSlash("http://localhost:4000");
